> **VISUAL CONTENT CLEANUP — 24 September 2026**
> This binder retains domain, technical, veterinary, health, AI, rabbit and operations provenance only. Its former embedded Design System Part J was removed so this file cannot act as a competing visual source. All presentation decisions live exclusively in `docs/ux/animal-farm-visual-lock/`.
