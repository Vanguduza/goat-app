...
GLOBAL_PROGRAMME_GATES = json.loads(r'''[{"gate_id":"PLATFORM_DECIMAL_SCALING_EXACT","status":"VERIFIED_ON_MAIN","blocking_phase":3,"evidence":["app/src/main/java/com/farmos/app/ExactDecimalInput.kt","app/src/test/java/com/farmos/app/ExactDecimalInputTest.kt","app/src/main/java/com/farmos/app/SalesModuleHost.kt","app/src/main/java/com/farmos/app/ProcurementModuleHost.kt","app/src/main/java/com/farmos/app/RabbitCommerceModuleHost.kt","app/src/main/java/com/farmos/app/FeedModuleHost.kt","app/src/main/java/com/farmos/app/WaterModuleHost.kt","app/src/main/java/com/farmos/app/OperatingModuleHost.kt"],"requirement":"All persisted human decimal inputs use exact checked decimal-to-integer scaling; floating-point scale-and-truncate conversion is forbidden.","verification":{"commit_sha":"4925b3eabb4acc44edcca7c5627b237dfd76ab27","workflow_run_id":35979597036,"conclusion":"success"}},{"gate_id":"PLATFORM_SYNC_SINGLE_OWNER_ATOMIC_CLAIM","status":"VERIFIED_ON_MAIN","blocking_phase":3,"evidence":["app/src/main/java/com/farmos/app/FarmSessionContent.kt","app/src/main/java/com/farmos/app/FarmOsApplication.kt","core/database/src/main/kotlin/com/farmos/core/database/FarmOsDatabase.kt","core/sync/src/main/kotlin/com/farmos/core/sync/SyncEngine.kt","core/sync/src/test/kotlin/com/farmos/core/sync/SyncEngineTest.kt"],"requirement":"On-demand sync is unique-work serialized and every transport send requires a successful atomic leased outbox claim; expired leases remain recoverable.","verification":{"commit_sha":"4925b3eabb4acc44edcca7c5627b237dfd76ab27","workflow_run_id":35979597036,"conclusion":"success"}},{"gate_id":"PLATFORM_SESSION_REVOCATION","status":"VERIFIED_ON_MAIN","blocking_phase":3,"evidence":["core/network/src/main/kotlin/com/farmos/core/network/SupabaseClients.kt","core/network/src/test/kotlin/com/farmos/core/network/SupabaseIdentityClientTest.kt","app/src/main/java/com/farmos/app/FarmOsApplication.kt","app/src/main/java/com/farmos/app/MainActivity.kt"],"requirement":"Explicit user sign-out attempts Supabase server session revocation with local scope and always clears local credentials; authorization-loss clearing remains local-only.","verification":{"commit_sha":"4925b3eabb4acc44edcca7c5627b237dfd76ab27","workflow_run_id":35979597036,"conclusion":"success"}},{"gate_id":"PLATFORM_GRADLE_REPRODUCIBLE_WRAPPER","status":"VERIFIED_ON_MAIN","blocking_phase":3,"evidence":["gradlew","gradlew.bat","gradle/wrapper/gradle-wrapper.jar","gradle/wrapper/gradle-wrapper.properties","scripts/ci/verify-actions-pinned.sh"],"requirement":"Repository ships the standard Gradle 9.3.1 wrapper and verifies the Gradle distribution SHA-256; CI and local Android scripts execute through ./gradlew.","verification":{"commit_sha":"f553fc2c1a59e79895d69f2b875e13fccc1dec84","workflow_run_id":35985454568,"conclusion":"success"}},{"gate_id":"PLATFORM_ANDROID_ARTIFACT_ASSEMBLY","status":"VERIFIED_ON_MAIN","blocking_phase":3,"evidence":[".github/workflows/foundation-ci.yml"],"requirement":"Canonical CI must assemble a non-empty debug APK from the wrapper-driven build and hash the resulting artifact.","verification":{"commit_sha":"f553fc2c1a59e79895d69f2b875e13fccc1dec84","workflow_run_id":35985454568,"conclusion":"success"}},{"gate_id":"PLATFORM_CI_ACTIONS_IMMUTABLE","status":"VERIFIED_ON_MAIN","blocking_phase":3,"evidence":[".github/workflows/foundation-ci.yml",".github/workflows/animal-farm-handover.yml",".github/workflows/project-truth-autolog.yml","scripts/ci/verify-actions-pinned.sh"],"requirement":"Every GitHub Action reference in canonical workflows is pinned to an immutable 40-character commit SHA.","verification":{"commit_sha":"f553fc2c1a59e79895d69f2b875e13fccc1dec84","workflow_run_id":35985454568,"conclusion":"success"}},{"gate_id":"PLATFORM_RECONCILER_DECOMPOSITION","status":"VERIFIED_ON_MAIN","blocking_phase":3,"evidence":["data/herd/src/main/kotlin/com/farmos/data/herd/FarmOsPullReconciler.kt","data/herd/src/main/kotlin/com/farmos/data/herd/RoomOpsRepository.kt","data/herd/src/main/kotlin/com/farmos/data/herd/FarmOsDataHelpers.kt","scripts/ci/verify-kotlin-architecture.sh"],"requirement":"Pull reconciliation, local ops mutation orchestration and shared data helpers are separate bounded source units with CI no-growth ceilings.","verification":{"commit_sha":"f553fc2c1a59e79895d69f2b875e13fccc1dec84","workflow_run_id":35985454568,"conclusion":"success"}}]''')
